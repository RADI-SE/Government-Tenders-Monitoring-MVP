...
const rawTenders = [
  {
    ...
    purpose:
      "توريد وتركيب كاميرات مراقبة وأنظمة إنذار حريق لمبنى الإدارة الرئيسي",
    description:
      "توريد وتركيب كاميرات مراقبة وأنظمة إنذار حريق لمبنى الإدارة الرئيسي",
    status: "معتمدة",
  ...
  },
  {
    ...
    purpose:
      "تقديم خدمات الصيانة والتشغيل لشبكات الصرف الصحي بالمدينة الصناعية لمدة 3 سنوات",
    description:
      "تقديم خدمات الصيانة والتشغيل لشبكات الصرف الصحي بالمدينة الصناعية لمدة 3 سنوات",
    ...
    tender_activities: [
      {
        ...
        activity: {
          id: 183,
          name: "خدمات صيانة واصلاح المنتجات المعدنية والحاويات والصهاريج",
        },
      },
    ],
    construction_works: [],
    ...
    suppliers: [],
    awarded_suppliers: [],
    local_content_mechanisms: [{ id: 999002, name: "القائمة الإلزامية" }],
    attachments: [],
    analytics: null,
