...
export default defineSchema({
  ...
  tenders: defineTable({
    ...
    .index("by_agency_id", ["agency_id"])
    .index("by_region_id", ["region_id"])
    .index("by_activity_ids", ["activity_ids"])
    .index("by_favorite", ["favorite"])
    .searchIndex("by_tender_name", {
      searchField: "tender_name",
    }),
